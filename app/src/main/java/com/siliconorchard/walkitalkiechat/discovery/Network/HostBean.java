...
package com.siliconorchard.walkitalkiechat.discovery.Network;
...
public class HostBean implements Parcelable {
    ...
    public static final String EXTRA = Constant.SELF_PACKAGE_NAME + ".extra";
    public static final String EXTRA_POSITION = Constant.SELF_PACKAGE_NAME + ".extra_position";
    public static final String EXTRA_HOST = Constant.SELF_PACKAGE_NAME + ".extra_host";
    public static final String EXTRA_TIMEOUT = Constant.SELF_PACKAGE_NAME + ".network.extra_timeout";
    public static final String EXTRA_HOSTNAME = Constant.SELF_PACKAGE_NAME + ".extra_hostname";
    public static final String EXTRA_BANNERS = Constant.SELF_PACKAGE_NAME + ".extra_banners";
    public static final String EXTRA_PORTSO = Constant.SELF_PACKAGE_NAME + ".extra_ports_o";
    public static final String EXTRA_PORTSC = Constant.SELF_PACKAGE_NAME + ".extra_ports_c";
    public static final String EXTRA_SERVICES = Constant.SELF_PACKAGE_NAME + ".extra_services";
